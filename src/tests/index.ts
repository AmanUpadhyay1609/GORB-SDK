...
try {
  ...
  const customSDK = createSDK({ blockchain: customConfig });
...
try {
  console.log("✅ GORB.TOKEN22_PROGRAM:", GORB.TOKEN22_PROGRAM.toBase58());
  console.log("✅ GORB.ASSOCIATED_TOKEN_PROGRAM:", GORB.ASSOCIATED_TOKEN_PROGRAM.toBase58());
  console.log("✅ GORB.SYSTEM_PROGRAM:", GORB.SYSTEM_PROGRAM.toBase58());
  console.log("✅ GORB.CONFIG.rpcUrl:", GORB.CONFIG.rpcUrl);
} catch (error) {
